...
public class DriveConstants {
     ...
     */
    public static final double FOAM_TILE_INCH = 24;
    public static double WHEEL_RADIUS = 2; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 32.3; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(198.81635655013426);
    public static double MAX_ANG_ACCEL = Math.toRadians(198.81635655013426);
